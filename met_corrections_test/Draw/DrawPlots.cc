...
int DrawPlots()
{
  ...
  //load histos
  TFile *InputFile = new TFile("rawmet_histos.root","read");
  TH1F *h_met_dy = (TH1F*) InputFile->Get("h_met_dy")->Clone("h_met_dy");
  TH1F *h_met_wz = (TH1F*) InputFile->Get("h_met_wz")->Clone("h_met_wz");
  TH1F *h_met_zz = (TH1F*) InputFile->Get("h_met_zz")->Clone("h_met_zz");
  TH1F *h_met_ww = (TH1F*) InputFile->Get("h_met_ww")->Clone("h_met_ww");
  TH1F *h_met_data = (TH1F*) InputFile->Get("h_met_data")->Clone("h_met_data");
...
*/
  ...
  */
  ...
  v_met[0]->SetTitle("Data vs MC MET");
  v_met[0]->Draw();      //huh?
